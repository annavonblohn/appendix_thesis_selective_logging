...
typedef struct pft_estab *Pft_estab;
...
extern Stocks woodconsum(Patch *,Real);
extern void calc_nir(Patch *,Irrigation *,Real,Real [],Real,Bool);
extern Real rw_irrigation(Patch *,Real,const Real [],Real,const Config *);
extern void irrig_amount_river(Cell *,const Config *);
extern void irrig_amount(Patch *,Irrigation *,int,int,int,const Config *);
...
extern Harvest harvest_patch(Output *,Patch *,Real,const Config *);
...
extern Bool isirrigevent(const Patch *);
...
extern void freepftestab(Pft_estab,Bool);
